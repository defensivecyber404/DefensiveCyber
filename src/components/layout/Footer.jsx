...
export const Footer = () => {
  return (
    <footer className="bg-background-darker border-t border-white/10 pt-16 pb-8 relative overflow-hidden">
      {/* Background glow */}
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full glass-panel flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary/50 transition-all">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['About Us', 'Services', 'Case Studies', 'Pricing', 'Contact'].map((link) => (
                <li key={link}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Vulnerability Assessment', 'Penetration Testing', 'Cloud Security', 'Network Defense', 'Compliance Audits'].map((service) => (
                <li key={service}>
                  <a href="#" className="text-gray-400 hover:text-primary transition-colors text-sm flex items-center gap-2">
                    <span className="w-1 h-1 bg-primary rounded-full" />
                    {service}
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            Â© {new Date().getFullYear()} DefensiveCyber. All rights reserved.
          </p>
