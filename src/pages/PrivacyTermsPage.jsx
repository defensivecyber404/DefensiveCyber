    ...
    <main className="pt-32 pb-24 relative min-h-screen bg-[#030014] text-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 max-w-5xl">
        <div className="mb-12">
          <button 
            onClick={() => navigate(-1)}
            className="group flex items-center justify-center text-sm font-bold text-white hover:text-primary transition-all backdrop-blur-md bg-white/5 border border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.1)] hover:bg-white/10 px-6 py-2.5 rounded-full w-max cursor-pointer"
          >
